...
namespace OSImGui
{
	...
	public:
		...
		void NewTextColored(std::string Text, ImColor Color, bool isCenter);
		void NewText(std::string Text, bool isCenter);
		...
		void SwitchButton2(const char* str_id, bool* v);
		void SwitchButton3(const char* str_id, bool* v);
